...
def get_all_invoices_from_receipts():
    path = '/home/timon/workspace/m122/m122_LB2_EBill/tmp/receipts'
    ...
    for receipt in filtered_receipts:
        file = open('/home/timon/workspace/m122/m122_LB2_EBill/tmp/receipts/' + receipt, 'r')
...
def get_invoice_file(invoice_number):
    path = '/home/timon/workspace/m122/m122_LB2_EBill/tmp/six_files/'
