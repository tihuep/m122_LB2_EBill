...
def generate_txt(csv_data):
    template_file = open('/home/timon/workspace/m122/m122_LB2_EBill/templates/invoice_template.txt', 'r')
    lines = template_file.readlines()

    output_file = open('/home/timon/workspace/m122/m122_LB2_EBill/tmp/six_files/' + csv_data[1][2] + '_' + csv_data[0][0].split('_')[1] + '_' + 'invoice.txt', 'w')
    for line in lines:
        iterations = 1
...
def generate_xml(csv_data):
    template_file = open('/home/timon/workspace/m122/m122_LB2_EBill/templates/invoice_template.xml', 'r')
    lines = template_file.readlines()

    output_file = open('/home/timon/workspace/m122/m122_LB2_EBill/tmp/six_files/' + csv_data[1][2] + '_' + csv_data[0][0].split('_')[1] + '_' + 'invoice.xml', 'w')
    for line in lines:
        new_line = line
        for _ in [m.start() for m in re.finditer('\{', str(line))]:
            var_start = new_line.find('{')
